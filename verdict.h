...
/* quality functions for tet elements */
    ...
    /** Min( J, 1/J ), where J is determinant of weighted Jacobian matrix.
       Reference --- P. Knupp, Algebraic Mesh Quality Metrics for
       Unstructured Initial Meshes, submitted for publication. */ 
    C_FUNC_DEF double tet_relative_size_squared( int num_nodes, double coordinates[][3], double average_tet_size );

    //! Calculates tet shape-size metric.
    /** Product of Shape and Relative Size. 
       Reference --- P. Knupp, Algebraic Mesh Quality Metrics for
       Unstructured Initial Meshes, submitted for publication. */ 
    C_FUNC_DEF double tet_shape_and_size( int num_nodes, double coordinates[][3], double average_tet_size );
...
/* quality functions for quad elements */
    ...
    C_FUNC_DEF double quad_equiangle_skew( int num_nodes, double coordinates[][3] );
...
/* quality functions for triangle elements */
    ...
    //! Calculates triangle metric.
    /**  */
    C_FUNC_DEF double tri_shear( int num_nodes, double coordinates[][3] ); 
    ...
    C_FUNC_DEF double tri_equiangle_skew( int num_nodes, double coordinates[][3] );
